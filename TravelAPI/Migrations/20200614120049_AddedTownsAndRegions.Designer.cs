...
namespace TravelAPI.Migrations
{
    ...
    [Migration("20200614120049_AddedTownsAndRegions")]
    partial class AddedTownsAndRegions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelAPI.Core.Models.CompanyRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("CanAddPeoples")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TravelAPI.Core.Models.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelAPI.Core.Models.Town", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TravelAPI.Core.Models.UserCompanyRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TravelAPI.Core.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TravelAPI.Core.Models.Town", b =>
                {
                    b.HasOne("TravelAPI.Core.Models.Region", "Region")
                        .WithMany("Towns")
            ...
            modelBuilder.Entity("TravelAPI.Core.Models.UserCompanyRole", b =>
                {
                    b.HasOne("TravelAPI.Core.Models.CompanyRole", "CompanyRole")
                        .WithMany("Users")
                        .HasForeignKey("CompanyRoleId");

                    b.HasOne("TravelAPI.Core.Models.User", "User")
                        .WithMany("Roles")
                        .HasForeignKey("UserId");
                });
